...
[openclaw.com](https://openclaw.com) にアクセスして、Mac 用の OpenClaw をダウンロード・インストールしてください。
...
- 光の動き、明るさ、色は STATUS.md の値（気分、エネルギー、好奇心、安心度）に連動しています
- 画面の左下に、薄く状態値が表示されています（マウスを動かすと少し明るくなります）
